...
const kGoogleApiKey = "AIzaSyBMViyxEq8rW1QsE2pdQ4LZ3mbUytWmt0Y";
GoogleMapsPlaces _places = GoogleMapsPlaces(apiKey: kGoogleApiKey);

class SearchResultPage extends StatefulWidget {
  String placeId;

  SearchResultPage(String placeId) {
...
class PlaceDetailState extends State<SearchResultPage> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    final lng = location.lng;
    final center = LatLng(lat, lng);
    mapController.showMarkerInfoWindow(MarkerId(placeDetail.formattedAddress));
